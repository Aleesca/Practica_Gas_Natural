...
El modelo se ha construido diferenciando la acometida y acometida interior, la instalación común, los montantes y las instalaciones individuales de vivienda. La validación se apoya en la familia UNE 60670, en el Reglamento técnico de distribución y utilización de combustibles gaseosos aprobado por el Real Decreto 919/2006, y en el anejo de cálculos generado por DMElect. Los resultados muestran que el punto de menor presión dinámica corresponde al horno de la vivienda 1 en planta 1, con una presión de \SI{227,959}{mmca}, superior a la presión mínima de aparato considerada en el cálculo, \SI{180}{mmca}. La rama de mayor velocidad se localiza en la acometida, con \SI{15,43}{\meter\per\second}, por debajo del límite de \SI{20}{\meter\per\second}. Con estos valores, la instalación queda justificada hidráulicamente y documentada mediante los planos y el anejo incluidos al final de la memoria.
